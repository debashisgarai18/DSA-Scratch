...
// approach: using bs to find the minimum in the rotated array
// we need to find the sorted space and update the result val with the min in the sorted array
